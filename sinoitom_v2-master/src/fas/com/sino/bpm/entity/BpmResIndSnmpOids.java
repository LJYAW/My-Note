 ...
 **/
@Entity
@Table(name = "Bpm_ResIndSnmpOids", uniqueConstraints = @UniqueConstraint(columnNames = "resIndSnmpOid"))
public class BpmResIndSnmpOids {
    private Integer resMonIndSnmpOid;
    private Long resId;//'资源ID',
    private Integer resIndSnmpOid;//Cmdb_ResIndSnmpOid主键id
    ...
    private Integer resTypeIndId ;// '资源类型监测指标ID',
    ...
    private Integer status ;//'状态(1:已验证;0:未验证)',
    ...
    public Integer getResMonIndSnmpOid() {
        return resMonIndSnmpOid;
    }

    public void setResMonIndSnmpOid(Integer resMonIndSnmpOid) {
        this.resMonIndSnmpOid = resMonIndSnmpOid;
    }
