 ...
 **/
@Entity
@Table(name = "Cmdb_ResIndCmdParse", uniqueConstraints = @UniqueConstraint(columnNames = "chkItemId"))
public class CmdbResIndCmdParse {
    private Integer chkItemId;//'巡检指标项Id',
    ...
    private Long prodModelID;//'产品型号ID（-1代表所有型号）',
    ...
    private Integer status;//'0' COMMENT '状态(1:已审核;0:未审核)',
    ...
    public boolean equals(Object o) {
        ...
        CmdbResIndCmdParse that = (CmdbResIndCmdParse) o;
        return Objects.equals(resTypeIndId, that.resTypeIndId);
    }
