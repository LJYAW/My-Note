 ...
 */
@Component
public class VendorOSVersionDao extends BaseDao<VendorOSVersion,Integer>{

	@SuppressWarnings({ "rawtypes" })
	public List<ResItemParam> getAllVendor() {
		StringBuffer hql=new StringBuffer("select distinct b.vendorID,b.dispName ");
		hql.append("from VendorOSVersion a,CmdbVendor b where a.vendorID = b.vendorID  order by b.vendorID");
