...
public class NcmCablingInfoParam {
	...
	public String getUnVerifyIfName() {
		return unVerifyIfName;
	}

	public void setUnVerifyIfName(String unVerifyIfName) {
		this.unVerifyIfName = unVerifyIfName;
	}
