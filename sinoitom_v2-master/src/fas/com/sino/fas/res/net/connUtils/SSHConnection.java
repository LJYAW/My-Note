...
public class SSHConnection {
	...
	public void write(String value) throws IOException {
		...
		try {
			...
			logger.error("发命令异常:write({}){}", value, e.getMessage());
		}
	}
	...
	public static void main(String[] args) throws IOException {
		String host = "182.50.118.212", account = "sinobaas", password = "baas~123", enpwd = "Sino+bridge:80";
...
//		String enablePasswd =  "Sino+bridge:80";
		...
		devPrompt = base.write("\r", cmdPromt).replaceAll("\r\n", "").trim();
