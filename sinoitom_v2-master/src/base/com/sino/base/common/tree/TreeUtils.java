...
//	@SuppressWarnings("rawtypes")
//	public static String getHtmlTreeStr(final List list, String textAtt, String urlAtt) {
//		return getHtmlTreeStr(list, TREE_DEFAULT_COL_NAME, TREE_DEFAULT_LEVEL_LENGTH, textAtt, urlAtt);
//	}
//
//	@SuppressWarnings("rawtypes")
//	public static String getHtmlTreeStr(final List list, String treeAtt, int levelLength, String textAtt, String urlAtt) {
//		if( list==null ){
//			return "";
//		}
//		
...
//			}
//			sb.append("<li> <a href=\"").append(urlValue).append("\">").append(textValue).append("</a>");
//
...
//	}
	...
	/**
	 * getHtmlTreeStr
	 * @Description: TODO 将系统菜单转换为树状显示
	 * @param list	系统菜单树集合
	 * @param textAtt	菜单名称
	 * @param urlAtt		url菜单对应的路径
	 * @param iconAtt	icon菜单显示的图标
	 * @param menuIdAtt	菜单id
	 * @return: String
	 */
	@SuppressWarnings("rawtypes")
	public static String getHtmlTreeStr(final List list, String textAtt, String urlAtt, String iconAtt,String menuIdAtt) {
		return getHtmlTreeStr(list, TREE_DEFAULT_COL_NAME, TREE_DEFAULT_LEVEL_LENGTH, textAtt, urlAtt, iconAtt,menuIdAtt);
	}

	/**
	 * getHtmlTreeStr
	 * @Description: TODO 将系统菜单转换为树状显示具体执行
	 * @param list
	 * @param treeAtt	树编码默认字段名称treecode
	 * @param levelLength	树编码每级默认长度3
	 * @param textAtt	菜单名称
	 * @param urlAtt		url菜单对应的路径
	 * @param iconAtt	icon菜单显示的图标
	 * @param menuIdAtt	菜单id
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public static String getHtmlTreeStr(final List list, String treeAtt, int levelLength, String textAtt, String urlAtt, String iconAtt,String menuIdAtt) {
		if( list==null ){
			return "";
		}
		...
		for (int i = 0; i < nodeNum; i++)
		{
			...
			String textValue = Reflections.getFieldValue(list.get(i), textAtt).toString();
			Object urlObj = Reflections.getFieldValue(list.get(i), urlAtt);
			String menuId = Reflections.getFieldValue(list.get(i), menuIdAtt).toString();
			String urlValue = urlObj==null ? "javascript:void(0)":urlObj.toString();
			...
			if( StringUtils.isBlank(urlValue) ){
				...
				urlValue=urlValue+"?menuId="+menuId;
			}
			
			    if(urlValue.contains("javascript:void")){
			    	sb.append("<li> <a  class=\"dropdown-toggle\" href=\"").append(urlValue).append("\">");
			    }else{
			    	sb.append("<li> <a  class=\"\" href=\"").append(urlValue).append("\"").append("target='home'").append(">");
			    }
				
				sb.append("<i class=\"menu-icon fa fa-caret-right").append("\"></i>");
