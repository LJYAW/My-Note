...
public class ServiceUtils {
		...
		private static UserOperationService operationService=null;
		
		
		public static UserOperationService getUserOperationService() {
			if(operationService == null ){
				operationService = (UserOperationService) SpringContextHolder.getBean(UserOperationService.class);
			}
