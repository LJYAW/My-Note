        ...
        append: function (parentNode, newdata, nearNode, isAfter)
        {
            ...
            if (parentNode == null)//增加到根节点
            {
                ...
                $(".l-body", g.tree).hover(function ()
                {
                    ...
                    if($("#index-treeMenu li").find('ul').length>0){
                        $("#index-treeMenu li").find('ul').siblings('div').removeClass("l-over");
                        $("#index-treeMenu li").find('ul').siblings('div').css('cursor','default')
                    }
                }, function ()
                {
                ...
                { 
                    if (!treeitem.hasClass("l-unselectable"))
                    {
                        ...
                        else
                        {
                            ...
                            if($("#index-treeMenu li").find('ul').length>0){
                                $("#index-treeMenu li").find('ul').siblings('div').removeClass("l-selected");
                                $("#index-treeMenu li").find('ul').siblings('div').css('cursor','default')
                             }
                            g.trigger('select', [{ data: treenodedata, target: treeitem[0] }])
                        }
