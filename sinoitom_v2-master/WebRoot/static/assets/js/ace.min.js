...
window.onload=function(){
	...
	$(".no-skin .nav-list>li>.submenu li>.submenu>li a").click(function(){
	...
	$(".no-skin .nav-list>li>.submenu li>a").click(function(){		
		$(this).css({
			color:"#4B88B7",
			"background-color":"#F1F5F9"
		});
		...
		$(this).parent().siblings().children('.submenu').children('li').children('a').css({
			color:"#757575",
			"background-color":"#fff"
		});
		$(this).parent().parent().parent().siblings().children('.submenu').children('li').children('a').css({
			color:"#757575",
			"background-color":"#fff"
		});
	});
