...
//					}
		...
		*/
		 _ajax: function(field, rules, i, options) {
			 ...
			 var fieldMessage = rules[i+1];
			 var errorSelector = fieldMessage.split("~")[0];
			 ...
			 //编辑接收到的回显信息，用“~”做分隔符
			 var editBackMessage = fieldMessage.split("~")[1];
			 if(editBackMessage != undefined && editBackMessage != "" && editBackMessage != null){
				 if(editBackMessage == field.val()){
		...
		*/
		_buildPrompt: function(field, promptText, type, ajaxed, options) {
			...
			// create the prompt flag	//chen
//            var promptFlag = $('<div>').addClass("formErrorFlag").appendTo(prompt); //change
