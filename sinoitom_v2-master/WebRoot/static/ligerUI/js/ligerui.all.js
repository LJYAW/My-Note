    ...
    $.ligerui.controls.ComboBox.ligerExtend($.ligerui.controls.Input, {
        ...
        _setValue: function (value)
        {
            ...
            else
            {
				...
				$("table.l-table-checkbox :a", g.selectBox).removeClass("l-checkbox-checked");
                for (var i = 0; i < targetdata.length; i++)
                {
                    $("table.l-table-checkbox tr[value=" + targetdata[i] + "] :checkbox", g.selectBox).each(function () { this.checked = true; });
					$("table.l-table-checkbox tr[value=" + targetdata[i] + "] :a", g.selectBox).addClass("l-checkbox-checked");
                }
            }
        },
...
(function ($)
{
    ...
    $.ligerui.controls.DateEditor.ligerExtend($.ligerui.controls.Input, {
        ...
        _render: function ()
        {
            ...
            dateeditorHTML += "        <div></div><div class='l-box-dateeditor-header-btn l-box-dateeditor-header-prevyear'><span></span></div>";
            dateeditorHTML += "        <div></div><div class='l-box-dateeditor-header-btn l-box-dateeditor-header-prevmonth'><span></span></div>";
            dateeditorHTML += "        <div></div><div class='l-box-dateeditor-header-text'><a class='l-box-dateeditor-header-month'></a> , <a  class='l-box-dateeditor-header-year'></a></div>";
            dateeditorHTML += "        <div></div><div class='l-box-dateeditor-header-btn l-box-dateeditor-header-nextmonth'><span></span></div>";
            dateeditorHTML += "        <div></div><div class='l-box-dateeditor-header-btn l-box-dateeditor-header-nextyear'><span></span></div><div></div>";
            dateeditorHTML += "    </div>";
...
(function ($)
{
    ...
    //dialog 图片文件夹的路径 预加载
    $.ligerui.DialogImagePath = "/static/ligerUI/skins/Aqua/images/win/";
...
(function ($)
{
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            gridhtmlarr.push("                <div></div><div class='l-bar-group  l-bar-message'><span class='l-bar-text'></span></div><div></div>");
