...
function f_onAdd()
{
	...
	window.parent.showDlg('添加'+objName, editDlgWidth, editDlgHeight, timeURL(url) );     
	return false;
}
...
function editRow(id)
{
	...
	window.parent.showDlg('修改'+objName, editDlgWidth, editDlgHeight, url);     
}
...
function viewRow(id)
{
	...
	window.parent.showDlg('查看'+objName, viewDlgWidth, viewDlgHeight, url);     
}
