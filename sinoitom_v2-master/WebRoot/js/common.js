...
$(function(){
	$("#formSave input").filter(".formInput-S").ligerTextBox({width: 200});
	$("#formSave input").filter(".formInput-L").ligerTextBox({width: 554});
	$("#formSave textarea").filter(".formText").ligerTextBox({width: 554,height:80});
	$("#formSave select.formSelect").css("width","202px");
	$("#formSearch input").filter(".formInput-S").ligerTextBox({width: 200});
	$("#formSearch input").filter(".formInput-L").ligerTextBox({width: 554});
	$("#formSearch textarea").filter(".formText").ligerTextBox({width: 554,height:80});
	$("#formSearch select.formSelect").css("width","202px");
})
