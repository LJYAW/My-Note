...
//             });
            ...
            manager = gridMain = $("#maingrid").ligerGrid({
                columns:
                    [
                        {
                            display: '<span style="font-weight:bold; ">机构名称</span>',
                            name: 'orgName',
                            width: 80,
                            align: 'center',
                            type: 'text'
                        ...
                        {
                            display: '<span style="font-weight:bold; ">设备厂商</span>',
                            name: 'vendorName',
                            width: 80,
                            align: 'center',
                            type: 'text'
                        ...
                        {
                            display: '<span style="font-weight:bold; ">设备IP</span>',
                            name: 'mgmtIP',
                            width: 120,
                            align: 'left',
                            type: 'text'
                        ...
                        {
                            display: '<span style="font-weight:bold; ">设备类型</span>',
                            name: 'resTypeName',
                            width: 80,
                            align: 'center',
                            type: 'text'
                        ...
                        {
                            display: '<span style="font-weight:bold; ">设备型号</span>',
                            name: 'prodModel',
                            width: 120,
                            align: 'left',
                            type: 'text'
                        ...
                        {
                            display: '<span style="font-weight:bold; ">型号OID</span>',
                            name: 'modelOID',
                            width: 150,
                            align: 'left',
                            type: 'text'
                        ...
                        {
                            display: '<span style="font-weight:bold; ">操作系统类型</span>',
                            name: 'osType',
                            width: 80,
                            align: 'center',
                            type: 'text'
                        ...
                        {
                            display: '<span style="font-weight:bold; ">操作系统版本</span>',
                            name: 'osVerSort',
                            width: 100,
                            align: 'left',
                            type: 'text'
                        ...
                        {
                            display: '<span style="font-weight:bold; ">采集方式</span>',
                            name: 'accessMode',
                            width: 80,
                            align: 'center',
                            type: 'text'
                        ...
                        {
                            display: '<span style="font-weight:bold; ">巡检用户</span>',
                            name: 'userName',
                            width: 80,
                            align: 'center',
                            type: 'text'
