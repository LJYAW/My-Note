...
<body> 
	<form:form id="formSave" modelAttribute="ackResources" action="" method="post">
		...
		<table align="center" class="tb_edit">
            ...
            <tr>
                <td align="right">采集方式：</td>
                <td><input id="accessMode" name="accessMode" value="${ackResources.accessMode}" type="text" ltype="text" class=" ip1"readonly="readonly"/></td>
                <td ></td>
                
                <td align="right">巡检用户：</td>
                <td><input id="userName" name="userName" value="${ackResources.userName}" type="text" ltype="text" class="ip1" readonly="readonly"/></td>
                <td></td>
            </tr>
