...
<script type="text/javascript">
    ...
    function pageInit() {
        ...
        jQuery("#experimentalList").jqGrid({
            ...
            data: d,
            colModel: [
                {label: '巡检指标英文名称', name: 'ackChkIndItemEnName', index: 'ackChkIndItemEnName', width: 200},
                {label: '巡检指标中文名称', name: 'ackChkIndItemCnName', index: 'ackChkIndItemCnName', width: 200},
                {label: '巡检结果', name: 'ackChkValue', index: 'ackChkValue', width: 200}
            ],
            height: gridHeight,
            altRows: true
        });
