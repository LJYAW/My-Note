...
function pageInit(){
	 ...
	 colNames : [ '厂商标识', '厂商名称', '显示名称', '厂商OID', '备注' ,'status','审核状态'],
	 colModel : [ 
	        	 {name : 'vendorOID',index : 'vendorOID',width : 30},
		...
		function onadd(){
			 ...
			 layer_show("添加厂商OID",'${ctx}/cmdb/vendorOID/add.do?vendorId='+vendorId,800,350)
			}  
			function onEdit()
			{
		...
		function editRow(id)
		{
			layer_show("修改厂商OID",'${ctx}/cmdb/vendorOID/edit.do?id='+id,800,350)
		}
...
// 			alert(rowData.status);
		...
		function delRow(id)
		{
			var url = '${ctx}/cmdb/vendorOID/delete.do';
			$.ajax({
				url: url,
				type:"POST",
				dataType: 'json',
				...
				success: function(data) {
					if(data.result=="success"){
						layer.msg('删除成功!',{icon: 7,time:1500});
					}else{
	     ...
	     {
	     	var url = '${ctx}/cmdb/vendorOID/saveAudit.do?oids='+ids;
	     	$.ajax({
	     		url: url,
	     		//type:"POST",
				dataType: 'json',
