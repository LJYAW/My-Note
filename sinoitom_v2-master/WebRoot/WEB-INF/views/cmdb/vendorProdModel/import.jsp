...
//             refreshVendor();
        ...
        function onDownload()
        {
	    	window.location.href = "${ctx}/download.do?name=ProdModelImportExcel";	
        }
...
<!-- 	<div class="wFull hL"><a class="l-button" style="width:120px; margin-left:6px;" onclick="onDownload()">下载Excel模板</a></div> -->
  	<form id="formImport" action="${ctx}/cmdb/vendorProdModel/importExcel.do" method="post" enctype="multipart/form-data">
