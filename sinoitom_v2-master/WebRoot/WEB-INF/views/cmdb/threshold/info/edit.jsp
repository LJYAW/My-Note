              ...
              function (result) {
                  if (result.type != null) {
                      ...
                      for (var i = 0; i < result.type.length; i++) {
                          ...
                          if(group.type=='${items.indGroupID}'){
...
<body> 
	<form:form id="formSave" modelAttribute="threshold" action="${ctx}/cmdb/thresholdInfo/save.do" method="post">
    ...
    <table align="center" class="tb_edit" style="width:750px;margin-top:1px">
    	...
    	<tr>
    		...
    		<td colspan=4><input id="thresholdName" name="thresholdName" value="${thresholdType.thresholdName}" type="text" ltype="text" class="ip2" /></td>
    		<td></td>
    	</tr>
