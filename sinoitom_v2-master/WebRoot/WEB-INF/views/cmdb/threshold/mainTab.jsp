...
<script src="${ctx}/js/timePeriod.js" type="text/javascript"></script>
    <script type="text/javascript">
            ...
            onAfterSelectTabItem: function (tabid)
	            {
	               if(tabid=="tabitem1"){
	                     selTab="tabitem1";
	               		 $("#thresholdType_iframe").attr("src", '${ctx}/cmdb/thresholdType/main.do');    
	               }
	               else if(tabid=="tabitem2"){
	                    selTab="tabitem2";
	                    $("#thresholdItem_iframe").attr("src",'${ctx}/cmdb/thresholdInfo/main.do');    
	               } 
	            }
		...
		$(document).ready(window.onresize=function(){
				var wh=windowHeight();
				document.getElementById("thresholdType_iframe").style.height = (wh-32)+"px";
				document.getElementById("thresholdItem_iframe").style.height = (wh-32)+"px";
		});
		

		function saveOK(action, data){
			if(selTab=="tabitem1"){
			   var editor = document.getElementById("thresholdType_iframe").contentWindow;
	 			editor.saveOK(); 
			}else if(selTab=="tabitem2"){
			    var editor = document.getElementById("thresholdItem_iframe").contentWindow;
	 			editor.saveOK(); 
			}
       }
...
<div class="breadcrumbs ace-save-state" id="breadcrumbs">
	...
	<div id="cmdbTab" style="width:99%;overflow:hidden; border:1px solid #A3C0E8; ">
		...
		<div id="thresholdType" name="thresholdType"  title="阀值分类"  >
		  <iframe frameborder="0" id="thresholdType_iframe" src="" class="whFull"></iframe>
		</div>
		
		<div id ="thresholdItem" name="thresholdItem" title="阀值信息" >
		  <iframe frameborder="0" id="thresholdItem_iframe" src="" class="whFull"></iframe>
		</div>
