	              ...
	              function (result) {
	                  if (result.vendorOSVersionlist != null) {
	                      ...
	                      for (var i = 0; i < result.vendorOSVersionlist.length; i++) {
	                          ...
	                          if(osType.osName=='${prodChkCmds.osType}'){
...
<body> 
	<form:form id="formSave" modelAttribute="prodChkCmds" action="${ctx}/cmdb/prodChkCmds/saveEdit.do" method="post">
	<input type="hidden" id="action" name="action" value="${action}"/>
	<input type="hidden" name="id" value="${prodChkCmds.prodChkCmdId}"/>
	...
	<input type="hidden" id="status" name="status" value="0"/>
		<table align="center" class="tb_edit">
            ...
            <tr>
               ...
               <td>
                  <select id="osVersion" name="osVersion" style="width:202px">
                  </select>
               </td>  
               <td></td>
            </tr>
