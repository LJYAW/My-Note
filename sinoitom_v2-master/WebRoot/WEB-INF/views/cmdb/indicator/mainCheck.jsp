            ...
            onAfterSelectTabItem: function (tabid)
	            {
	             ...
	             if(tabid=="tabitem1"){
	                  selTab="tabitem1";
	                  $("#prodChkCmds_iframe").attr("src",'${ctx}/cmdb/prodChkCmds/getTree.do?title='+'${titleContent}');
	               }
	                else if(tabid=="tabitem2"){
	                selTab="tabitem2";
	                   $("#prodCmdCheckItems_iframe").attr("src",'${ctx}/cmdb/indicator/resIndCmdParse/getTree.do');
...
<div class="breadcrumbs ace-save-state" id="breadcrumbs">
	...
	<div id="cmdbTab" style="width:99%;overflow:hidden; border:1px solid #A3C0E8; ">
		<div id ="prodChkCmds" name="os" title="设备巡检命令" >
			  <iframe frameborder="0" id="prodChkCmds_iframe" src="" class="whFull"></iframe>
		</div>
		<div id ="prodCmdCheckItems" name="prodCmdCheckItems" title="指标解析规则" >
