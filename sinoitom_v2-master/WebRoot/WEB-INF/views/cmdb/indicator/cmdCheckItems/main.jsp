...
<script type="text/javascript">
    ...
    function onadd() {
        ...
        layer_show("添加", '${ctx}/cmdb/prodCmdCheckItems/toAdd.do?pid=' + '${pid}', 800, 550)
    }
    ...
    function saveAsRow(id) {
        layer_show("另存为", '${ctx}/cmdb/prodCmdCheckItems/toSaveAs.do?id=' + id, 1000, 550)
    }
    ...
    function delRow(id) {
        var url = '${ctx}/cmdb/prodCmdCheckItems/delete.do?';
        $.ajax({
            url: url,
            type: "POST",
            dataType: 'json',
    ...
    function auditRow(ids) {
        var url = '${ctx}/cmdb/prodCmdCheckItems/saveAudit.do?checkItemsIds=' + ids;
        $.ajax({
            url: url,
            dataType: 'json',
            success: function (data) {
