...
<body> 
	<form:form id="formSave" modelAttribute="prodChkCmdItems" action="${ctx}/cmdb/prodCmdCheckItems/saveAs.do" method="post">
		...
		<table align="center" class="tb_edit">
			<tr>
               ...
               <td align="right">产品分类 ：</td>
                 ...
                 <td><input id="devClassName" name="devClassName" value="${prodChkCmdItems.devClassName}" type="text" ltype="text" class=" ip1" readonly="readonly"/></td>
                <td ></td>
            </tr>
             <tr>
