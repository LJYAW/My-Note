...
<head>
    ...
    <script type="text/javascript">
        ...
        function saveAndContinue() {
            $.ajax({
                type: "POST",
                url: "${ctx}/cmdb/indicator/resIndCmdParse/saveProdCmdCheckItems.do",
                ...
                function (result) {
                    if (result.pClass != null) {
                        ...
                        for (var i = 0; i < result.pClass.length; i++) {
                            ...
                            if (pClass.prodClassCode == '${prodCmdCheckItems.resClassCode}') {
        ...
        function refreshOsFeature() {
            var vendorId = $("#vendorID").find("option:selected").val();
            var devClassCode = $("#resClassCode").find("option:selected").val();
        ...
        function refreshIndGroup() {
            var resClassCode = $("#resClassCode").find("option:selected").val();
            var resTypeCode = $("#resTypeCode").find("option:selected").val();
            var indClassCode = $("#indClassCode").find("option:selected").val();
            $.getJSON(
                "${ctx}/cmdb/indicator/resIndCmdParse/getIndGroup.do?resClassCode=" + resClassCode + "&resTypeCode=" + resTypeCode + "&indClassCode=" + indClassCode,
                function (result) {
        ...
        function refreshIndItems() {
            ...
            $.getJSON(
                "${ctx}/cmdb/indicator/resIndCmdParse/getIndItems.do?resClassCode=" + resClassCode + "&resTypeCode=" + resTypeCode + "&indClassCode=" + indClassCode + "&indGroupID=" + indGroupID,
                function (result) {
        ...
        function checkResults() {
            ...
            $.ajax({
                type: "POST",
                url: "${ctx}/cmdb/indicator/resIndCmdParse/checkResult.do",
...
<form:form id="formSave" action="" method="post">
    ...
    <table align="center" class="tb_edit">
        ...
        <tr>
            ...
            <td>
                <select id="resClassCode" name="resClassCode" style="width:202px"
        ...
        <tr>
            ...
            <td>
                <select id="resTypeCode" name="resTypeCode" style="width:202px"
