...
<form:form id="formSave" action="" method="post">
    ...
    <table align="center" class="tb_edit">
        ...
        <td><input id="resClassName" name="resClassName" value="${prodChkCmdItems.resClassName}" type="text"
                   ltype="text" class=" ip1" readonly="readonly"/></td>
        <td></td>
        </tr>
        <tr>
            <td align="right">产品类型：</td>
            <td><input id="resTypeName" name="resTypeName" value="${prodChkCmdItems.resTypeName}" type="text"
                       ltype="text" class=" ip1" readonly="readonly"/></td>
            <td></td>
