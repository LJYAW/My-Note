...
<body> 
	<form:form id="formSave" modelAttribute="prodIndItem" action="${ctx}/cmdb/prodIndItem/save.do" method="post">
		<table align="center" class="tb_edit">
            ...
            <tr id="special1">
               ...
               <td align="right">产品分类 ：</td>
                <td>
                <input value="${prodInd.devClassName}" type="text" ltype="text" class=" ip1" readonly/>
                </td>
                <td></td>
            </tr>
             ...
             <tr id="special2">
                ...
                <td>
                <input value="${prodInd.devTypeName}" type="text" ltype="text" class=" ip1" readonly/>
                </td>
               <td></td>
