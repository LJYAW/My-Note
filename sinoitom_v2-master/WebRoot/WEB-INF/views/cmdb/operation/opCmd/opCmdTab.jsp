...
<script type="text/javascript">
	...
	initDivHeight();//初始化div高度
		layout = $("#layout-index").ligerLayout({leftWidth : 240,space : 2,isLeftCollapse : false});
	...
	function fleshShow(id) {
				$("#resSnmpInd_iframe").attr("src",'${ctx}/cmdb/devOpCmd/main.do?id=' + id);
	}
	function saveOK(action, id,addSuccess) {
		 if (addSuccess == null || addSuccess == "") {
			fleshShow(productID);
		} else {
			window.location.href = "${ctx}/cmdb/devOpCmd/getTree.do";
		}
	}
// 	function getChecked() {
