...
<script type="text/javascript">
	...
	initDivHeight();//初始化div高度
		layout = $("#layout-index").ligerLayout({leftWidth : 260,space : 2,isLeftCollapse : false});
	...
	function fleshShow(id) {
				$("#resSnmpInd_iframe").attr("src",'${ctx}/cmdb/devOperation/main.do?id=' + id);
	}
	function saveOK(action, id,addSuccess) {
		 if (addSuccess == null || addSuccess == "") {
			fleshShow(productID);
		} else {
			window.location.href = "${ctx}/cmdb/devOperation/getTree.do";
		}
	}
// 	function getChecked() {
...
<div id="toptoolbar" ></div>
	<div id="layout-index" style="float:left;">
		<div position="left" id="tree-index" class="l-scroll l-accordion-content" style="border:1px solid #ccc; overflow:auto; clear:both;">
