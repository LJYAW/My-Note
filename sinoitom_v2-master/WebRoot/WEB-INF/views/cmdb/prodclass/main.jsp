...
function pageInit(){
	 ...
	 colNames : [ '厂商标识', '厂商名称', '产品分类编号', '产品分类名称', '分类描述', '审核状态','审核状态' ],
	 colModel : [ 
		...
		function onadd(){
			 ...
			 layer_show("添加产品分类",'${ctx}/cmdb/prodClass/add.do?vendorId=' + vendorId,800,400)
			}  
			function onEdit()
			{
		...
		function editRow(id)
		{
			layer_show("修改机构信息",'${ctx}/cmdb/prodClass/edit.do?id='+id,800,450)
		}
		...
		function delRow(id)
		{
			var url = '${ctx}/cmdb/prodClass/delete.do';
			$.ajax({
				url: url,
				type:"POST",
				dataType: 'json',
