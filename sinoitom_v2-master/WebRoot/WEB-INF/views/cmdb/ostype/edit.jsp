...
function refreshVendor() {
  	...
  	function changeVendorName(){
  	    var vendorName=$("#vendorID").find("option:selected").attr("vendorName");
...
<body> 
	<form:form id="formSave" modelAttribute="osType" action="${ctx}/cmdb/ostype/save.do" method="post">
	...
	<input type="hidden" name="vendorName" id="vendorName" value=""/>
		<table align="center" class="tb_edit">
            ...
            <tr>
                ...
                <td> <select id="vendorID" name="vendorID" style="width:202px" onchange="changeVendorName();">
                    <option value="-1">请选择</option>
                </td>
                <td></td>
                <td align="right">操作系统分类：</td>
                <td>
                  <s:resSelect id="osClassCode" name="osClassCode" value="${osType.osClassCode}" code="IT_OSType"  ltype="select" style="width:202px" />
                </td>
                <td></td>
            </tr>
            <tr>
                <td align="right">类型描述：</td>
                <td colspan="4"><input id="description" name="description" value="${osType.description}" type="text" ltype="text" class="validate[optional,maxSize[32]] ip2" /></td>
                <td></td>
            </tr>
            <tr>
            	<td>&nbsp;&nbsp;</td>
