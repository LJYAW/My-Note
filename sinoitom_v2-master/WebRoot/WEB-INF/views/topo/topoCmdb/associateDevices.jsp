            ...
            gridMain = $("#maingrid").ligerGrid({
                columns: 
                  ...
                  { display: 'id', name: 'id', width: 100, hide:true},
                   { display:'机构名称', name:'organName', width:80, align:'left' },
                    { display:'交换机名称', name:'devName', width:150, align:'left' },
                    { display:'IP地址', name:'devIpLong', width:100, align:'left',type:'long',
                     render:function(row){
                      return row.devIpAddr;
                       }
                     },
                    { display:'设备厂商', name:'vendorName', width:60, align:'center' },
                    { display:'设备类型', name:'typeName', width:60, align:'center' },
                    { display:'产品系列', name:'prodSeries', width:80, align:'center' },
                    { display:'设备型号', name:'prodModel', width:110, align:'center' },
                    { display:'启用Snmp', name:'snmpEnabled', width:70, align:'center' },
                    { display:'访问方式', name:'devAccess', width:60, align:'center' },
                    { display:'缺省网关', name:'gatewayIP', width:100, align:'left' },
                   ], 
               	checkbox: 'true', 
               	alternatingRow: 'true' ,
				data: dataMain,
...
//                 rownumbers:true, 
     ...
     function onload (){
    	$.ajax({
    		url:" ${ctx}/cmdb/graph/getAllNcmDevices.do",
    		dataType: 'json',
    		success: function(data) {
