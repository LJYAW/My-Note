...
<script type="text/javascript">
    ...
    function pageInit(){
        jQuery("#list").jqGrid( {
            ...
            colModel : [
                ...
                {name : 'snmpObjName',index : 'snmpObjName',width : 80},
                {name : 'snmpOID',index : 'snmpOID',width : 260},
    ...
    function delRow(id)
    {
        var url = '${ctx}/bpm/bpmResIndSnmpOids/delete.do?';
        $.ajax({
            url: url,
            type:"POST",
            dataType: 'json',
    ...
    {
        var url = '${ctx}/bpm/bpmResIndSnmpOids/saveAudit.do?devChkItemIds='+ids;
        $.ajax({
            url: url,
            dataType: 'json',
            success: function(data) {
    ...
    function onView(){
        ...
        layer_show("巡检指标详情",'${ctx}/bpm/bpmResIndSnmpOids/view.do?id=' +rowid,750,500);
    }
