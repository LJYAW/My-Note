...
<script type="text/javascript">
    ...
    function pageInit() {
        jQuery("#list").jqGrid({
            ...
            datatype: "local",
            colNames: ['IP地址','资源分类','资源类型','厂商','产品型号','操作系统','版本分类','软件特征','指标组','指标名称','指标英文名称','数据类型','长度','小数位数','度量单位','采集方式','验证状态'],
            colModel: [
                {name: 'resIp', index: 'resIp', width: 100},
                {name: 'resClassName', index: 'resClassName', width: 100},
                {name: 'resTypeName', index: 'resTypeName', width: 100},
                {name: 'vendorName', index: 'vendorName', width: 100},
                {name: 'prodModel', index: 'prodModel', width: 100},
                {name: 'osType', index: 'osType', width: 100},
                {name: 'osVersion', index: 'osVersion', width: 100},
                {name: 'osFeature', index: 'osFeature', width: 100},
            ...
            sortname: 'resIp', //要排序的字段 //默认表格加载时根据fca09列排序
