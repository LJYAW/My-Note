    ...
    var clusterId = '${clusterId}';
        ...
        */
        ...
        function sendform(){
            ...
            if (ids==""||ids==null) { 
            	 layer.msg('请选择要关联的服务器!', {icon: 7, time: 1500});
        ...
        function relationSave(ids){
        	var url = '${ctx}/res/host/clusterHosts/relationSave.do?ids='+ids+'&&clusterId='+clusterId;
        	$.ajax({
        		url: url,
        		dataType: 'json',
        		success: function(data) {
        			if( data.result == 'success' ){
        				layer.msg('关联服务器成功!',{icon:1, time: 1000},function(){
        					window.parent.saveOK();
            		        window.parent.closeDlg();
        	            });
        				
        			}else{
        				layer.msg('关联服务器失败!',{icon:7, time: 1000},function(){
        					window.parent.saveOK();
            		        window.parent.closeDlg();
        	            });
        			}
...
<div>
	...
	<div align="center" >
		<input id="bnSave" type="button" value="关联服务器" onclick="sendform()" class="l-button mg6" />
	</div>
</div>
