...
// 					$("#taMsg").text(data.message); 
	...
	function sendForm(){
	var url = timeURL('${ctx}/system/util/snmpUtilMain.do?date='+new Date());
...
<body > 
	...
	<form id="formSearch" action="" method="post">
		<table id="tbSearch" align="center" class="tb_edit" style="width:750px;">
			...
			<tr>
			  <td align="right" nowrap><span style="font-weight:bold;">Snmp版本：</span></td>
			  <td>
			  ...
			  <td></td>
			  <td align="right" nowrap><span style="font-weight:bold;">超时时间（秒）：</span></td>
            ...
            <tr>
                <td align="right" nowrap><span style="font-weight:bold;">设备IP地址：</span></td>
                <td colspan=4><input id="devIp" name="devIp" value="" type="text" ltype="text" class="validate[required[设备IP地址不能为空],maxSize[512]] ip2" /></td>
                <td align="center"><input id="bnSnmpUtil" type="button" value="窗口模式"  onclick="sendForm()" class="l-button mg6" style="width:88px;"/></td>
                <td></td>
            </tr>
            <tr>
                <td align="right" nowrap><span style="font-weight:bold;">Snmp OID：</span></td>
