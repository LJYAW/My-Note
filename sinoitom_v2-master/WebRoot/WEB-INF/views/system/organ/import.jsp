...
<script src="${ctx}/static/jquery-validationEngine/jquery.validationEngine.js" type="text/javascript" charset="utf-8"></script> 
	...
	var message = '${message}';
        ...
        function onDownload()
        {
	    	window.location.href = "${ctx}/download.do?name=organImportExcel";	
        }
...
<body style="padding:0px; overflow:hidden; "> 
	<div class="wFull hL"><a class="l-button" style="width:120px; margin-left:6px;" onclick="onDownload()">下载Excel模板</a></div>
  	<form id="formImport" action="${ctx}/system/organ/importExcel.do" method="post" enctype="multipart/form-data">
