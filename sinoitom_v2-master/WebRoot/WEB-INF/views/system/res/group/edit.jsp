...
<body> 
	<form:form id="formSave" modelAttribute="group" action="${ctx}/system/res/group/save.do" method="post">
		...
		<input type="hidden" name="resGrpId" value="${group.resGrpId}"/>
		<table align="center" class="tb_edit">
            ...
            <tr>
                ...
                <td><input id="grpName" name="grpName" value="${group.grpName}" type="text" ltype="text" class="validate[required[字典名称不能为空],maxSize[64]] ip1" /></td>
                <td></td>
                <td align="right">字典项关系:</td>
               
                <td>
                 <s:resSelect name="grpType" value="${group.grpType}" code="resGroupType" ltype="select"  style="width: 180px;"/>
                </td>
                <td></td>
            </tr>
            <tr>
                <td align="right">字典编码:</td>
                <td><input id="grpCode" name="grpCode" value="${group.grpCode}" type="text" ltype="text" class="validate[required[字典编码不能为空],maxSize[64]] ip1" /></td>
                <td></td>
                <td align="right">字典项类型:</td>
                <td><s:resSelect name="itemType" value="${group.itemType}" code="resItemType" ltype="select" style="width: 180px;" /></td>
                <td>
                </td>
                <td></td>
            </tr>   
            ...
            <tr>
                ...
                <td colspan=4><s:resSelect name="state" value="${group.state}" code="resGroupState" ltype="select" style="width: 180px;" /></td>
                <td></td>
            </tr>   
            <tr>
                <td align="right">用户可添加:</td>
                <td align="left" colspan=4><form:checkbox path="isCanAdd" /></td>
                <td></td>
            </tr>   
            <tr>
            ...
            <tr>
                ...
                <td align="left" colspan=4><form:checkbox path="isCanDel" /></td>
                <td></td>
            </tr>   
            <tr>
