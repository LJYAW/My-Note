...
<script type="text/javascript">
		 $(function (){
            if('${action}'=='search'){
	            window.parent.reloadGrid(${jsonStr});
            }
        });
...
<body style="padding:0px; overflow:hidden; "> 
    	...
    	<table align="center" class="tb_edit">
            ...
            <tr>
                ...
                <td><s:resSelect name="filter_EQI_grpType" style="width:100%" code="resGroupType" prompt="全部" ltype="select"/></td>
                <td></td>
                <td align="right">字典项类型:</td>
                <td><s:resSelect name="filter_EQI_itemType" style="width:100%" code="resItemType" prompt="全部" ltype="select"/></td>
                <td></td>
            </tr>   
            <tr>
