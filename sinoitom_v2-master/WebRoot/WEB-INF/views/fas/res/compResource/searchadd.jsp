...
var linuxOSType ;
   ...
   function  getRadio(){ 
        ...
        if(e.value=='0'){	//输入用户名密码
	    	$("#checkform").css("display","none");
	    	$("#addform").css("display","");
	    	$("#devAcsTr").css("display","none");
	    	$("#devAcsTr2").css("display","none");
	    	$("#inputAccess").css("display","none");
	    	$("#usnamePsTr").css("display","");
	    	$("#seleAccess").css("display","");
	    }else if(e.value=='1'){		//下拉选择用户
	    	$("#checkform").css("display","");
	    	$("#addform").css("display","none");
	    	$("#devAcsTr").css("display","");
	    	$("#devAcsTr2").css("display","");
...
<body >
	<form id="formSave" modelAttribute="resHosts" action="${ctx}/fas/res/host/resHosts/searchAddsave.do" method="post">
		...
		<table align="center" class="tb_edit">
			...
			<tr>
				...
				<td><s:resSelect id="resTypeCode" name="resTypeCode" value="1" code="IT_HostType" ltype="select" style="width: 200px;" onchange="getHostType();"/></td>
				<td></td>
			</tr>
...
<%--			宿主机从表res_hosts中查询hostType=2的数据列出ipAdderss		--%>
					<select id="homedHostId" name="homedHostId" style="width:200px;height: 25px;" class="Tr resTypeCodeTR" >
                  	</select>
				</td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td>
					<s:resSelect id="osClass" name="osClass" value="3" code="IT_OSType"  ltype="select" style="width:200px" onchange="getOsType()"/>
				</td>
				<td></td>
				<td align="right" nowrap="nowrap">操作系统类型：</td>
				<td>
<%--					<select id="osType" name="osType"  class="Tr" style="width:200px;height: 25px;" onchange="getOsVersion()"></select>--%>
					<input readonly="readonly" id="osType" name="osType" type="text" ltype="text" class="ip1 Tr"  />
				</td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td >
					<span onclick="getRadio();">
						<input id="inpu1" type="radio" name="checkradio" value="0" >手动输入凭证
	    				<input id="inpu2" type="radio" name="checkradio" value="1">从凭证表选择
					</span>
				</td>
				<td></td>
...
<%--			<tr id="devAcsTr">--%>
<%--					<td align="right">用户凭证：</td>--%>
<%--					<td>--%>
<%--					<select id="devAcsUserId" name="devAcsUserId" style="width:200px;height: 25px;" class="Tr">--%>
<%--                  	</select>--%>
<%--                	</td>--%>
<%--                	<td></td>--%>
<%--                	<td></td>--%>
...
<%--				<td>--%>
<%--					<select id="osVersionType" name="osVersionType"  class="Tr" style="width:200px;height: 25px;" ></select>--%>
<%--				</td>--%>
<%--				<td></td>--%>
				<td align="right">访问方式：</td>
				<td>
<%--					<select name="accessmode" id="accessmode" style="width:200px;height: 25px;" class="Tr" onchange="getAccessPort();">--%>
...
<%--					</select>--%>
			...
			<tr id="seleAccess">
				<td align="right">访问方式：</td>
				<td>
					<select name="accessmode1" id="accessmode1" style="width:200px;height: 25px;" class="Tr">
						<option value="SSH" >SSH</option>
						<option value="Telnet" >Telnet</option>
					</select>
				</td>
				...
				<td align="right">访问端口：</td>
				<td>
					<input id="accessPort1" name="accessPort1" value="22" type="text" ltype="text" onchange="checkAccessPort();" class="ip1 Tr"  />
				</td>
				<td></td>
			</tr>
			...
			<tr id="addform">
           		<td align="center" colspan=6 >
           			<input id="bnAdd" type="button" value="添加凭证" onclick="addform()" class="l-button mg6" />
           		</td>
            </tr>
<%--            <tr id="checkform">--%>
<%--           		<td align="center" colspan=6 >--%>
<%--           		<input id="bnCheck" type="button" value="访问验证" onclick="checkform()" class="l-button mg6" />--%>
<%--           		</td>--%>
<%--            </tr>--%>
<%--            <tr id="subform">--%>
<%--           		<td align="center" colspan=6 >--%>
<%--           		<input id="bnSave" type="button" value="搜索添加" onclick="sendform()" class="l-button mg6" />--%>
<%--           		</td>--%>
<%--            </tr>--%>
			<tr id="checkform">
