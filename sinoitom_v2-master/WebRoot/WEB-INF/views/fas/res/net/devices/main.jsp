...
<!-- 							</button> -->
							...
							<button class="btn btn-white btn-purple btn-bold" onclick="fdbTable()">
								<i class="ace-icon fa fa-check-square-o bigger-120 "></i>
								转发表
							</button>
							<button class="btn btn-white btn-purple btn-bold" onclick="onSnmpRefresh()">
								<i class="ace-icon fa fa-check-square-o bigger-120 "></i>
								自动更新
							</button>
...
function getData() {
	...
	$.ajax({
        ...
        function onScan()
        {
        	var url = '${ctx}/fas/res/net/devices/scanGo.do';
     		layer_show("搜索交换机", url, 800, 400);
        }
