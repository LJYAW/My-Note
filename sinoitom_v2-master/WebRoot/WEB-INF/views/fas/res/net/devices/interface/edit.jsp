	...
	<form id="formSave" action="${ctx}/fas/res/net/switch/interface/save.do" method="post">
		...
		<table align="center" class="tb_edit">
            ...
            <tr>
                ...
                <td><s:resSelect name="adminStatus" value="${itf.adminStatus}" code="dev_AdminStatus" ltype="select" /></td>
                <td></td>
                <td align="right">工作状态:</td>
                <td><s:resSelect name="operStatus" value="${itf.operStatus}" code="dev_OperStatus" ltype="select" /></td>
                <td></td>
            </tr>
            <tr>
