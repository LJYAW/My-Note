...
<head>
    ...
    <script type="text/javascript">
        ...
        function onRefresh(){
            window.location.href='${ctx}/fas/res/mdlware/info.do?devIpAddr='+devIpAddr+'&content='+content+'&tomcatVersion='+tomcatVersion;
        }
        ...
        function showTomcatView(id,devIpAddr,content) {
            ...
            var url = timeURL('${ctx}/fas/res/mdlware/showTomcatView.do?id=' + id+'&devIpAddr='+devIpAddr+'&content='+content);
