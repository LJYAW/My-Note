            ...
            $("#lineTab").ligerTab({
                ...
                onAfterSelectTabItem: function (tabid)
                {
                    if(tabid=="tabitem1"){
                        ...
                        num++;
                        if(num==0){
                            $("#lineItem_iframe").attr("src",'${ctx}/fas/res/mdlware/showLine.do?id=' + id+'&devIpAddr='+devIpAddr+'&content='+content);
                        }
                    }
                    else if(tabid=="tabitem2"){
                          selTab="tabitem2";
                          if(num2==0){
                              $("#memoryItem_iframe").attr("src", '${ctx}/fas/res/mdlware/showMemory.do?id=' + id+'&devIpAddr='+devIpAddr+'&content='+content);
                          }
                        num2++;
                    }
	                   ...
	                   selTab="tabitem3";
	                   if(num3==0){
                           $("#threadItem_iframe").attr("src", '${ctx}/fas/res/mdlware/showThread.do?id=' + id+'&devIpAddr='+devIpAddr+'&content='+content);
                       }
                        num3++;
                    }
	                   ...
	                   selTab="tabitem4";
	                   if(num4==0){
                           $("#loadedClassItem_iframe").attr("src", '${ctx}/fas/res/mdlware/showLoadedClass.do?id=' + id+'&devIpAddr='+devIpAddr+'&content='+content);
                       }
                       num4++;
	               }
                }
