...
<script src="${ctx}/static/ipv4lib.js" type="text/javascript"></script><script src="${ctx}/static/jquery-validationEngine/languages/jquery.validationEngine-zh_CN.js" type="text/javascript" charset="utf-8"></script><script src="${ctx}/static/jquery-validationEngine/jquery.validationEngine.js" type="text/javascript" charset="utf-8"></script>
	...
	<script type="text/javascript">
        ...
        function JMXmonitorLineStartCpu(){
            $.ajax({
                // type: "POST",
                url: '${ctx}/fas/res/mdlware/app/index/JMXmonitorLineStartCpu.do?service='+service+'&userName='+userName+'&psWord='+psWord,
        ...
        $(function () {
            ...
            function SetYdata(){
                ...
                $.ajax({
                    // type: "POST",
                    url: "${ctx}/fas/res/mdlware/app/index/JMXmonitorLineView.do?service="+service+'&userName='+userName+'&psWord='+psWord,
                    async: false, //表示同步，如果要得到ajax处理完后台数据后的返回值，最好这样设置
                    success: function (data) {
            ...
            function SetYdata4(){
                ...
                $.ajax({
                    // type: "POST",
                    url: "${ctx}/fas/res/mdlware/app/index/JMXmonitorLineViewCPU.do?service="+service+"&intervalTime="+intervalTime+'&userName='+userName+'&psWord='+psWord,
                    async: false, //表示同步，如果要得到ajax处理完后台数据后的返回值，最好这样设置
                    success: function (data) {
