 ...
 * @LastEditTime: 2021-09-26 15:52:32
...
<template>
  <div class="timbre">
    ...
    <el-form-item class="timbar-box comment-box">
      <el-switch v-model="form.timbreSwitch" active-color="#13ce66" inactive-color="#DEDEDE" class="switch-btn" />
...
export default {
  ...
  watch: {
    ...
    'form.timbreSwitch': {
      handler(newName, oldName) {
        this.$store.commit('jianshi/SET_TIMBRESWITCH', newName)
      },
      immediate: true
    }
  },
  created() {
    this.form.timbre = this.audioTimbreList[0]
    // this.getTimbreData()
  },
  mounted() {
  ...
  methods: {
    ...
    // async getTimbreData() {
    //   const params = {
    //     query: 'media_type:audio,sub_type:音色',
    //     sortby: 'id',
    //     order: 'desc',
    //     limit: 10000,
    //     page: 1,
