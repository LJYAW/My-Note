 ...
 * @LastEditTime: 2021-10-14 15:52:11
...
export default {
  ...
  computed: {
    ...mapState('jianshi', ['effectList', 'effectData', 'virtual_presenter', 'submitData', 'hostPosition']),
    // 画面图片位置
    presen_postion_img() {
  ...
  watch: {
    presen_radio(val) {
      this.$store.commit('jianshi/set_hostPosition', val)
    },
    // // 监听回显
