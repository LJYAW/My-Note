 ...
 * @LastEditTime: 2020-12-03 17:52:43
  ...
  <div class="material_wrap">
    <div class="top">
      <div class="top_item d-flex">
        ...
        <a class="tags" @click="tags()">标签列表</a>
      </div>
      <div class="top_item d-flex mt-15px">
        <div class="d-flex flex-1">
          <span class="label_title">视频状态:</span>
          <el-select v-model="form.video_status" placeholder="请选择" class="video_status">
            <el-option
        ...
        <div class="mt-10px d-flex flex-1">
          <span>素材总数:</span>
          <span>500</span>
        </div>
        <div class="reset">
