 ...
 * @LastEditTime: 2021-09-26 16:41:03
  ...
  <div class="subtitle-wrap">
    ...
    <div class="subtitle-box">
      ...
      <div class="position-box">
        ...
        <el-input v-model="bottom" class="bottom" type="number" min="0" max="92" placeholder="" @change="bottomChange" />
        <span>%</span>
      </div>
      <div class="btns">
...
export default {
  ...
  methods: {
    ...
    determine() {
      this.$store.commit('jianshi/SET_SUBTITLE', this.bottom / 100)
