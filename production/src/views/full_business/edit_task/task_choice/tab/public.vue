...
<template>
  <div class="public-wrap">
    <div class="search-top">
      ...
      <div class="item-search">
        <span>频道:</span>
        <el-select v-model="form.channel_id" filterable clearable placeholder="请选择频道或搜索" style="width:100%">
          <el-option
      ...
      <div class="item-search">
        <span>栏目:</span>
        <el-select v-model="form.item_id" filterable clearable placeholder="请选择栏目或搜索" style="width:100%">
          <el-option
  ...
  methods: {
    ...
    getProcessingRequire() {
      ...
      this.$get('/production/processingRequire').then(res => {
        const { data } = res
        this.machining_options = data.complete
      }).catch(res => {
        console.log(res)
      })
    },
