 ...
 * @LastEditTime: 2021-06-01 15:08:04
  ...
  <div class="task-met">
    ...
    <div style="margin-top:36px">
      ...
      >
        ...
        <el-table-column prop="date" label="播出日期" width="110" />
        <el-table-column prop="start_time" label="播出时间" width="160">
          <template slot-scope="scope">
            <el-popover
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      const url = '/production/taskControl'
    ...
    exportData() {
      ...
      axios({
        method: 'get',
        url: '/production/taskControlExport',
        headers: {
          token: this.token
        },
        params: {
        ...
        .then(res => {
          if (res.data.type) {
            ...
            link.setAttribute('download', '整档任务列表.xlsx')
            link.click()
            link = null
