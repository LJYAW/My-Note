 ...
 * @LastEditTime: 2021-04-16 10:20:28
      ...
      <div>
        <div class="search-list">
          ...
          <div class="item-serach">
            ...
            <el-select v-model="form.send" filterable placeholder="请选择推送状态">
              <el-option
    ...
    <div style="margin-top:20px">
      ...
      <el-table :data="tableData" class="table-list" border>
        ...
        <el-table-column prop="" label="操作" width="260px">
          <template slot-scope="scope">
            <!-- <a v-if="scope.row.status == '转码成功'" class="start-task" @click="playVideo(scope)">播放视频</a> -->
            <base-btn
